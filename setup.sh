...
echo "   - http://localhost:5000/parallel (parallel test)"
echo "   - http://localhost:5000/status (status)"
echo ""
echo "🖥️  To test with Virtual Machine:"
echo "   1. Install VirtualBox and Vagrant"
echo "   2. Run: vagrant up"
echo "   3. Run: vagrant ssh"
echo "   4. Inside VM: cd /vagrant && python3 app.py"
echo ""
